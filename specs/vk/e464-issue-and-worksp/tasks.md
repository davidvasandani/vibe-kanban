...
- [x] T004 Run focused regression tests, backend checks and `pnpm run format`; record results in `specs/vk/e464-issue-and-worksp/validation.md`.
...
- [x] T007 Open PR against main and merge after checks.
