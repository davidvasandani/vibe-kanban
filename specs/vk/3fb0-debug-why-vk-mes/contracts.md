...
// crates/services/src/services/normalized_log_cache.rs — re-base surviving
// entry indices onto a fresh array; live-store path only. Returns the
// entries and the number of operations that could not be placed.
