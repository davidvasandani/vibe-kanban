...
- [ ] T001 Merge current `origin/main` into the task branch and reconcile only
      this task's root/SpecKit artifacts.
- [ ] T002 Add an internal testable async-I/O seam in
...
- [ ] T003 Add a deterministic failing regression in
...
- [ ] T005 Ensure mandatory hook-response write failures return/log an explicit
...
- [ ] T006 [P] Add/adjust focused tests for true-quiescence shutdown,
...
- [ ] T007 [P] Update task verification notes under
      `specs/vk/5cd1-debug-this-vk-ba/` with the reproduced ordering and exact
      commands (depends on T005).

## Phase 4: Verification and review

- [ ] T008 Run focused executor tests and Rust formatting; run broader checks
      proportionate to the final diff (depends on T006).
- [ ] T009 Run independent Codex diff review, address every confirmed
      significant finding, and rerun affected checks until clean (depends on
      T008).
- [ ] T010 Update the existing lifecycle/poller knowledge page and index with
