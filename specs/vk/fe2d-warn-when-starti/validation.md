...
- Unused translation-key check and full `scripts/check-i18n.sh` passed: no new literals, duplicate JSON keys or missing locale keys.
...
Integrated main after PR #295 landed. Conflicts were limited to shared root planning documents; retained this task’s versions and preserved the new sidebar metadata-cache implementation and knowledge pages.
