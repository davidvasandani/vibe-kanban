...
- [x] T007 Run `pnpm install --frozen-lockfile`, formatting checks, and the
  relevant executor/backend checks required by `AGENTS.md` (depends on T006).
- [x] T008 Record verification evidence in
  `specs/vk/af0d-no-conversation/verification.md` (depends on T007).

## Phase 4: Review, knowledge, and merge

- [x] T009 Run an independent Codex diff review, address confirmed findings,
...
- [x] T010 Update the reusable Vibe Kanban knowledge in
