...
- FR-3: Deployment age must be measured from the immutable release timestamp,
  and browser or service reloads must not reset it.
...
- [ ] Reloading the page retains an age derived from the immutable release,
