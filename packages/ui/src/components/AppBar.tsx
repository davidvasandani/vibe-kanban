...
interface AppBarProps {
  ...
  /** Organization tile rendered at the very top of the rail. */
  orgSlot?: ReactNode;
  /** Opens the global settings dialog from the bottom utility cluster. */
  onOpenSettings?: () => void;
      ...
      <div className="mt-auto pt-base flex flex-col items-center gap-4">
        {onOpenCommandBar && (
          <Tooltip content="Command bar" side="right">
            ...
            >
              <ListIcon className="size-icon-base" weight="bold" />
            </button>
          </Tooltip>
        )}
        {onOpenSettings && (
          <Tooltip content="Settings" side="right">
            <button
              ...
              aria-label="Settings"
            >
              <GearIcon className="size-icon-base" weight="bold" />
            </button>
          </Tooltip>
        )}
        {notificationBell}
