...
| [shared-mcp-configuration](shared-mcp-configuration.md) | Shared MCP definitions are derived from native configs and written per executor; covers transactional modal assignment editing, editor-codec vs materializer compatibility, and authenticated HTTP gateway behavior | `a898-allow-mcp-server`, `4ae2-add-a-shared-mcp`, `76d1-vk-mcp-ux` |
