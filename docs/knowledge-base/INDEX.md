...
| [mcp-oauth-connect](mcp-oauth-connect.md) | The Connect flow for auth-required MCP servers: RFC 9728/8414 discovery, DCR, PKCE, hardened outbound URL/DNS policy, configured callback origins, state-bearing manual completion, bounded flow storage, token-file permissions, frontend gotchas, and the stub-E2E test recipe | `0c92-mcp-test-connect`, `205d-harden-mcp-oauth` |
