...
use api_types::{
    ...
    IssueTag, ListIssuesQuery, ListIssuesResponse, LowDiskFilesystemObservation, MemberRole,
    Notification, NotificationGroupKind, NotificationPayload, NotificationType, OrganizationMember,
    Project, ProjectStatus, PullRequest, PullRequestIssue, PullRequestStatus,
    ResolveLowDiskIssueRequest, ResolveLowDiskIssueResponse, SearchIssuesRequest, SortDirection,
    Tag, UpdateIssueCommentReactionRequest, UpdateIssueCommentRequest, UpdateIssueRequest,
...
fn export_shapes() -> String {
    ...
    let type_decls = vec![
        ...
        LowDiskFilesystemObservation::decl(),
        ResolveLowDiskIssueRequest::decl(),
        ResolveLowDiskIssueResponse::decl(),
