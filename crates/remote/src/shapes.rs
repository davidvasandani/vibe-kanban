...
// =============================================================================
// Single-issue shape (fork addition)
// =============================================================================

/// Syncs a single issue by ID. Used by `LinkedIssueContext` to give
/// workspace-scoped components a live view of the linked kanban issue.
pub const SINGLE_ISSUE_SHAPE: ShapeDefinition<Issue> = crate::define_shape!(
    name: "SINGLE_ISSUE_SHAPE",
    table: "issues",
    where_clause: r#""id" = $1"#,
