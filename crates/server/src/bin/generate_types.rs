...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        db::models::workspace_creation_progress::WorkspaceCreationPhase::decl(),
        db::models::workspace_creation_progress::WorkspaceCreationProgress::decl(),
        ...
        db::models::browser_session::BrowserSession::decl(),
        db::models::browser_session::BrowserSessionDbStatus::decl(),
        db::models::browser_session::CreateBrowserSession::decl(),
        db::models::browser_session::BrowserControlTransition::decl(),
        services::services::browser::types::BrowserController::decl(),
        services::services::browser::types::ControlTransitionReason::decl(),
        services::services::browser::types::BrowserControlState::decl(),
        services::services::browser::types::BrowserSessionStatus::decl(),
        services::services::browser::types::BrowserSessionLiveState::decl(),
        services::services::browser::types::MouseButton::decl(),
        services::services::browser::types::BrowserAction::decl(),
        services::services::browser::types::BrowserActionResult::decl(),
        ...
        server::routes::browser_sessions::BrowserReleaseRequest::decl(),
        server::routes::browser_sessions::BrowserTransferTargetRequest::decl(),
        server::routes::browser_sessions::BrowserTransferRequest::decl(),
        server::routes::browser_sessions::BrowserActionRequest::decl(),
        server::routes::browser_sessions::BrowserCloseQuery::decl(),
        server::routes::browser_sessions::BrowserWsServerMessage::decl(),
        server::routes::browser_sessions::BrowserWsClientMessage::decl(),
        ...
        api_types::OrganizationEnvVar::decl(),
        api_types::ListOrganizationEnvVarsResponse::decl(),
        api_types::CreateOrganizationEnvVarRequest::decl(),
        api_types::CreateOrganizationEnvVarResponse::decl(),
        api_types::UpdateOrganizationEnvVarRequest::decl(),
        api_types::UpdateOrganizationEnvVarResponse::decl(),
        ...
        server::routes::config::TestMcpServersBody::decl(),
        executors::shared_mcp_config::SharedMcpProfile::decl(),
        executors::shared_mcp_config::McpTransportKind::decl(),
        executors::shared_mcp_config::McpServerDefinition::decl(),
        ...
        executors::shared_mcp_config::SharedMcpConflict::decl(),
        executors::shared_mcp_config::SharedMcpProfileError::decl(),
        executors::shared_mcp_config::SharedMcpReadResponse::decl(),
        executors::shared_mcp_config::SharedMcpServerInput::decl(),
        executors::shared_mcp_config::SharedMcpConflictResolution::decl(),
        executors::shared_mcp_config::SharedMcpWriteRequest::decl(),
        executors::shared_mcp_config::SharedMcpWriteStatus::decl(),
        executors::shared_mcp_config::SharedMcpProfileWriteStatus::decl(),
        executors::shared_mcp_config::SharedMcpProfileWriteOutcome::decl(),
        executors::shared_mcp_config::SharedMcpWriteResponse::decl(),
        executors::shared_mcp_config::SharedMcpTestTarget::decl(),
        executors::shared_mcp_config::SharedMcpTestRequest::decl(),
        server::routes::config::SharedMcpAssignmentTestResult::decl(),
        executors::mcp_test::McpServerTestResult::decl(),
        ...
        services::services::aws_sso::AwsProfileImportCandidate::decl(),
        services::services::aws_sso::AwsProfileImportRequest::decl(),
        services::services::aws_sso::AwsProfileImportResult::decl(),
        ...
        server::routes::workspaces::execution::StartPollerError::decl(),
        server::routes::workspaces::execution::StartPollerRequest::decl(),
        server::routes::workspaces::execution::PollerSummary::decl(),
        server::routes::workspaces::execution::ListPollersResponse::decl(),
        ...
        services::services::pipelines::PipelineValidation::decl(),
        services::services::pipelines::PipelineFileStatus::decl(),
        server::routes::pipelines::PipelineRawBody::decl(),
        server::routes::pipelines::PipelineValidateBody::decl(),
        api_types::speckit::SpecKitStage::decl(),
        api_types::speckit::SpecKitTask::decl(),
        api_types::speckit::SpecKitTaskLayer::decl(),
        api_types::speckit::SpecKitTasks::decl(),
        api_types::speckit::SpecKitArtifact::decl(),
        api_types::speckit::SpecKitArtifacts::decl(),
        api_types::speckit::SpecKitUpdateArtifactRequest::decl(),
        api_types::speckit::SpecKitToggleTaskRequest::decl(),
        api_types::speckit::SpecKitStageArtifact::decl(),
        api_types::speckit::SpecKitTaskStatus::decl(),
        git::GitBranch::decl(),
        ...
        executors::mcp_refresh::McpRefreshStatus::decl(),
        executors::mcp_refresh::McpRefreshErrorCategory::decl(),
        executors::mcp_refresh::McpRefreshError::decl(),
        executors::mcp_refresh::McpDiscoveryObservation::decl(),
        executors::mcp_refresh::McpServerRefreshStatus::decl(),
        executors::mcp_refresh::McpServerRefreshSnapshot::decl(),
        executors::mcp_refresh::McpRefreshResult::decl(),
        executors::mcp_recovery::McpRecoveryScope::decl(),
        executors::mcp_recovery::McpRecoveryStatus::decl(),
        executors::mcp_recovery::McpRestartDisposition::decl(),
        executors::mcp_recovery::McpRecoveryResult::decl(),
        executors::actions::ExecutorActionType::decl(),
        executors::profile::ExecutorConfig::decl(),
        executors::actions::script::PollerSpec::decl(),
