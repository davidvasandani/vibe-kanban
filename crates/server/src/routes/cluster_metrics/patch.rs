...
//!
//! - **A resnapshot targets `/nodes`, `/generated_at`, and `/disk_alert_thresholds`,
//!   never the document root.** The consuming hook (`useJsonPatchWsStream`) mutates an Immer
